...
Route::middleware(['auth.admin', 'admin.verified'])->group(function () {
    ...
    Route::group(['prefix' => 'products'], function(){
        ...
        Route::get('update-size-product/{productSize}/{product}', [ProductController::class, "editSizeProduct"])->name('admin.edit_size_product');
    ...
    Route::middleware('auth.admin_author:admin')->group(function () {
        ...
        Route::group(['prefix' => 'setting'], function(){
            ...
            Route::post('/', [SettingController::class, "store"])->name('admin.setting_store');
        });
